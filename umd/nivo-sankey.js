(function (global, factory) {
    ...
    var Sankey = function Sankey(_ref) {
        ...
        var sankey = d3Sankey.sankey().nodeSort(sort).nodeAlign(sankeyAlignmentFromProp(align)).nodeWidth(nodeWidth).nodePadding(nodePaddingY).size([width, height]).nodeId(getId);
